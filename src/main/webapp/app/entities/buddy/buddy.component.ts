...
export default class Buddy extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public prepareRemove(instance: IBuddy): void {
  ...
  public removeBuddy(): void {
    this.buddyService()
      ...
      .then(() => {
        const message = 'A Buddy is deleted with identifier ' + this.removeId;
