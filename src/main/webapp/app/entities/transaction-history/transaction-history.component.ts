...
export default class TransactionHistory extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllTransactionHistorys();
  }
  ...
  public retrieveAllTransactionHistorys(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.transactionHistories.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: ITransactionHistory): void {
  ...
  public removeTransactionHistory(): void {
    this.transactionHistoryService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A TransactionHistory is deleted with identifier ' + this.removeId;
